...
<script type="text/javascript">
    ...
    $(function () {
        $('#ta').edatagrid({
            ...
            destroyUrl: "${pageContext.request.contextPath}/Cdelete",

            //该方法在edatagtid中，通过URL更新数据到服务器并返回更新的行。
            updateUrl: "${pageContext.request.contextPath}/Cupdate",
            toolbar: toolbar,
            url: '${pageContext.request.contextPath}/CselectAll',
    ...
    function doAdd() {
        $("#ff").form("submit", {
            url: "${pageContext.request.contextPath}/Aadd",
            //回调函数
...
<div id="dd">
    <form id="ff" method="post" enctype="multipart/form-data">
        ...
        图片: <input type="file" name="uploadFile" id="">
